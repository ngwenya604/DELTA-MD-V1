...
let dec = `> DELTA-MD-V1 ᴀɴɪᴍᴇ ɪᴍɢꜱ`
...
await conn.sendMessage(from,{image :{ url: `https://i.waifu.pics/aD7t0Bc.jpg` },caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ delta ᴛᴇᴄʜ ' },{quoted:mek});

await conn.sendMessage(from,{image :{ url: `https://i.waifu.pics/PQO5wPN.jpg` },caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ delta ᴛᴇᴄʜ ' },{quoted:mek});

await conn.sendMessage(from,{image :{ url: `https://i.waifu.pics/5At1P4A.jpg` },caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ delta ᴛᴇᴄʜ' },{quoted:mek});

await conn.sendMessage(from,{image :{ url: `https://i.waifu.pics/MjtH3Ha.jpg` },caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ delta ᴛᴇᴄʜ' },{quoted:mek});

await conn.sendMessage(from,{image :{ url: `https://i.waifu.pics/QQW7VKy.jpg` },caption: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ delta ᴛᴇᴄʜ' },{quoted:mek});
