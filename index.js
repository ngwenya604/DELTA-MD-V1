...
const MENU_IMG = "https://files.catbox.moe/0go0uy.jpg"
  ...
  const ownerNumber = ['263788521064','237677224245']
...
const port = process.env.PORT || 9090;
  ...
  console.log('DELTA-MD-V1 connected to whatsapp ✅')
  
  let up = `*╭──────────────●●►*
> *➺ CONGRATS DELTA-MD-V1 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ FRONTIER ✅*
    ...
    if (update.action === 'add') {
      for (let user of update.participants) {
        ...
        try {
          ...
          pfp = "https://files.catbox.moe/6nylub.jpg";
        }
...
Let's make this group even more awesome together! 🙌✨`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263788521064', '237682698517');
